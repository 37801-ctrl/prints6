...
MONGODB_URI=mongodb+srv://Mateste08:Mateste08@cluster0.rzpklp8.mongodb.net/?appName=Cluster0
# Chave secreta para assinar os tokens JWT
# Use uma string longa e aleatória (ex: gerada em https://randomkeygen.com/)
JWT_SECRET=7|8DwDu3Pk&PB%5x
...
EMAIL_PORT=587
EMAIL_USER=seuemail@gmail.com #meu email pessoal
EMAIL_PASS=sua_senha_de_app_gmail #senha que aparecer no navegador
